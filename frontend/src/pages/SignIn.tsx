              ...
              <div className="card-body p-5">
                <div className="text-center mb-4">
                  ...
                  <p className="text-muted">
                    Tired of chores? Let MapMe help you find the services you need
                  </p>
                </div>

                <div className="d-grid gap-3 mt-4">
                  <button onClick={hosted} className="btn btn-primary btn-lg">
                    <svg
                ...
                <div className="mt-4 text-center">
                  <small className="text-muted">
                    Sign in supports Google, Facebook, and Apple accounts
                  </small>
                </div>
              </div>
            </div>
